                            ...
                            <td class="px-5 py-4 align-middle">
                                <div class="flex items-center gap-3.5">
                                    @if($product && $product->featured_image)
                                        <img src="{{ asset('storage/' . $product->featured_image) }}" alt="{{ $product->name }}" class="w-12 h-12 object-contain rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shrink-0 p-1" />
                                    @else
